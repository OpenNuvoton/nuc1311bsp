 ...
 * @file     adc.h
 * @version  V3.00
 * @brief    NUC1311 Series ADC Driver Header File
 *
 * @note
 *
...
/**
  ...
  * @note NUC1311 series MCU ADC can only convert 1 channel at a time. If more than 1 channels are enabled, only channel
